...
# Modifikace pro osetreni zadani_vstupu
...
def tah_hrace(pole, symbol2):
    ...
    while True:
        #### osetruje si chybu, zabranuje tomu aby funkce skoncila
        try:
            cislo_policka=int((input("Na kterou pozici chces hrat? Zadej 0-19: ")))
        except ValueError as e:
            print('chyba Value Error - zadej cislo, ne text')
        except Exception as e:
            print('neznama chyba', e)
        ### konec osetreni chyby

        else:
            print("ok, input je v poradku - jedeme dal")
