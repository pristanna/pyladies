...
# Me otazky
# co dela toto?     print(zlate_stranky[klic]) # vypisuje hodnotu

#Slovnik lze prochazet standardnim for-cyklem
#V takovem pripade for pouziva klice - standartni chovani
...
for hodnota in zlate_stranky.values():
    print(hodnota)
    print(zlate_stranky[klic]) # Toto vraci jine poradi nez ten predchozi - ve slovniku neni poradi garantovano - na to jsou seznamy

#Pokud je potreba oboje, lze pouzit metodu items(), ktera vraci dvojice (klic, hodnota)
print('Prochazeni dvojic klic-hodnota pomoci polozek - zlate_stranky.items()')
